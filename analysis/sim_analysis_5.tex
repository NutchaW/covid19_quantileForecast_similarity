...
FALSE # Groups:   horizon [2]
FALSE   horizon time          `n()`
FALSE   <chr>   <chr>         <int>
FALSE 1 2       Stable period    36
FALSE 2 2       Up period        36
FALSE 3 4       Stable period    36
FALSE 4 4       Up period        36
\end{verbatim}

\begin{figure}

{\centering \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corex-1} \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corex-2} \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corex-3} \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corex-4} 
...
{\centering \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corm1-1} 
...
{\centering \includegraphics[width=1\linewidth,height=1\textheight]{sim_analysis_5_files/figure-latex/corm2-1} 
