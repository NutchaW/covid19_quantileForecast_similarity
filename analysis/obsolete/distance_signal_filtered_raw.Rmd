...
# get all location to calculate
# locs_ord[c(26,9,11,19,5)] - 29, 17,51,37,34------29, 13,17,37,45
# all - 24,35,54,51
# locs_ord[c(18,35,36,10,17,20)]: t - 18,35,54,04,21,24------18
...
```{r}
for(j in 1:length(c(locs_noadj,comb_locs))){
  loc <- c(locs_noadj,comb_locs)[j]
  p1 <- x %>%
    dplyr::left_join(truth_dates1, by=c("location"))  %>%
